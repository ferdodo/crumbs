...
`);let so=class extends HTMLElement{async connectedCallback(){this.attachShadow({mode:"open"});const n=R(this),e=oo.content.cloneNode(!0);n.appendChild(e)}};customElements.define(io,so);const uo=Ct.bind(at),ao="crumbs-panel",co=ct(uo`
	<style>
		:host {
			display: block;
		}
...
`);class lo extends HTMLElement{constructor(){super(...arguments);w(this,"contentTimeoutElapsed",!1);w(this,"contentLoaded",!1);w(this,"connected",!1);w(this,"loading","100");w(this,"scrolled",!1);w(this,"scrolledSubscription",null)}static get observedAttributes(){return["panel-loading","panel-title"]}async connectedCallback(){this.attachShadow({mode:"open"}),await no;const e=R(this),r=co.content.cloneNode(!0);e.appendChild(r);const o=this.getAttribute("panel-loading");o!==null&&Ae(o)&&(this.loading=o),setTimeout(()=>{const i=C(e,"#panel-container");i.style.gridTemplateColumns="1rem 1fr 1rem",i.style.gridTemplateRows="1rem 1fr 1rem";const s=C(e,"#panel");s.style.backgroundColor="#ffffff40",this.scrolledSubscription=B(s,"scroll").pipe($(u=>u.target.scrollTop),$(u=>u!==0)).subscribe(u=>{this.scrolled=u,this.render()}),this.render()},10),setTimeout(()=>{this.contentTimeoutElapsed=!0,this.render()},400),this.connected=!0,this.render()}render(){const e=R(this),r=C(e,"#panel-content"),o=C(e,"#panel-loading"),i=C(e,"#panel"),s=C(e,"#panel-title-content");this.contentTimeoutElapsed&&fo(this.loading)?(r.style.visibility="visible",r.style.opacity="1",i.style.overflow="auto"):(r.style.visibility="collapse",r.style.opacity="0",i.style.overflow="hidden"),o.style.width=`${this.loading}%`;const u=C(e,"#panel-title");this.loading==="100"&&this.getAttribute("panel-title")&&!this.scrolled?setTimeout(()=>{u.style.opacity="1",s.innerHTML=this.getAttribute("panel-title")||"",r.style.paddingTop="2.5rem"},10):(r.style.paddingTop="inherit",u.style.opacity="0")}attributeChangedCallback(){if(this.shadowRoot&&this.connected){const e=this.getAttribute("panel-loading");e!==null&&Ae(e)?this.loading=e:e===null&&(this.loading="100"),this.render()}}disconnectedCallback(){var e;(e=this.scrolledSubscription)==null||e.unsubscribe()}}function Ae(t){const n=Number(t),e=Math.floor(n);return e===n&&Number.isInteger(e)&&Number.isFinite(e)&&e<=100&&e>=0}function fo(t){return t===null||t==="100"}customElements.define(ao,lo);const po=Ct.bind(at),bo="crumbs-input",ho=ct(po`
	...
	<input type="text"/>
`);class mo extends HTMLElement{static get observedAttributes(){return["value"]}async connectedCallback(){this.attachShadow({mode:"open"});const n=R(this),e=ho.content.cloneNode(!0);n.appendChild(e);const r=C(n,"input"),o=this.getAttribute("value");r instanceof HTMLInputElement&&o&&(r.value=o)}attributeChangedCallback(n,e,r){if(n==="value"&&this.shadowRoot){const o=R(this),i=C(o,"input");i instanceof HTMLInputElement&&(i.value=r)}}}customElements.define(bo,mo);const Gt=Ct.bind(at),vo="crumbs-tabs",_o=ct(Gt`
	<style>
		:host {
			display: block;
		}
...
`);class yo extends HTMLElement{constructor(){super(...arguments);w(this,"selected",1);w(this,"subscriptions",[])}async connectedCallback(){this.attachShadow({mode:"open"});const e=R(this),r=_o.content.cloneNode(!0);e.appendChild(r);const o=this.getAttribute("selected");this.selected=Number.parseInt(o||"1");const i=e.querySelector("#tabs"),s=e.querySelector("#content");if(!i)throw new Error("Tabs not found");if(!s)throw new Error("Content not found");for(const u of{[Symbol.iterator]:()=>this.getSlots()}){if(u.startsWith("content-")){const a=Gt`<div id=${`${u}`}> <slot name=${u}></slot> </div>`;a instanceof Element&&s.appendChild(a)}if(u.startsWith("title-")){const a=Gt`<div id=${u}> <crumbs-p> <slot name=${u}></slot> </crumbs-p> </div>`;a instanceof Element&&i.appendChild(a)}}this.subscriptions=[...i.children].map((u,a)=>B(u,"click").subscribe(()=>{const l=u.id.replace("title-","content-"),f=e.querySelector(`#${l}`);f instanceof HTMLElement&&s instanceof HTMLElement&&f.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}),this.selected=a+1,this.render()})),this.render()}render(){const r=R(this).querySelector("#tabs");if(!r)throw new Error("Tabs not found");[...r.children].forEach((o,i)=>{i+1===this.selected?o instanceof HTMLElement&&o.classList.add("selected-title"):o instanceof HTMLElement&&o.classList.remove("selected-title")})}disconnectedCallback(){for(const e of this.subscriptions)e.unsubscribe()}*getSlots(){for(const e of Array.from(this.children)){const r=e.getAttribute("slot");r&&(yield r)}}}customElements.define(vo,yo);var qn=function(t,n,e,r){var o;n[0]=0;for(var i=1;i<n.length;i++){var s=n[i++],u=n[i]?(n[0]|=s?1:2,e[n[i++]]):n[++i];s===3?r[0]=u:s===4?r[1]=Object.assign(r[1]||{},u):s===5?(r[1]=r[1]||{})[n[++i]]=u:s===6?r[1][n[++i]]+=u+"":s?(o=t.apply(u,qn(t,u,e,["",null])),r.push(o),u[0]?n[0]|=2:(n[i-2]=0,n[i]=o)):r.push(u)}return r},je=new Map;function go(t){var n=je.get(this);return n||(n=new Map,je.set(this,n)),(n=qn(this,n.get(t)||(n.set(t,n=function(e){for(var r,o,i=1,s="",u="",a=[0],l=function(d){i===1&&(d||(s=s.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?a.push(0,d,s):i===3&&(d||s)?(a.push(3,d,s),i=2):i===2&&s==="..."&&d?a.push(4,d,0):i===2&&s&&!d?a.push(5,0,!0,s):i>=5&&((s||!d&&i===5)&&(a.push(i,0,s,o),i=6),d&&(a.push(i,d,0,o),i=6)),s=""},f=0;f<e.length;f++){f&&(i===1&&l(),l(f));for(var c=0;c<e[f].length;c++)r=e[f][c],i===1?r==="<"?(l(),a=[a],i=3):s+=r:i===4?s==="--"&&r===">"?(i=1,s=""):s=r+s[0]:u?r===u?u="":s+=r:r==='"'||r==="'"?u=r:r===">"?(l(),i=1):i&&(r==="="?(i=5,o=s,s=""):r==="/"&&(i<5||e[f][c+1]===">")?(l(),i===3&&(a=a[0]),i=a,(a=a[0]).push(2,0,i),i=0):r===" "||r==="	"||r===`
`||r==="\r"?(l(),i=2):s+=r),i===3&&s==="!--"&&(i=4,a=a[0])}return l(),a}(t)),n),arguments,[])).length>1?n:n[0]}const wo=go.bind(at),xo="crumbs-button",Le=1e3;class So extends HTMLElement{constructor(){super();w(this,"_renderSubscription",null);w(this,"_clickSubscription",null);w(this,"_attributeChanges$",new ce);w(this,"_parsedProgress$");w(this,"_parsedDisabled$");w(this,"_parsedIndeterminateProgress$");w(this,"_parsedIndeterminateDurationMs$");w(this,"_indeterminedLoadingAt$");w(this,"_loading$");w(this,"_activeIndeterminateProgress$");w(this,"_disabled$");w(this,"_loadingBarTransitionEnabled$");this._parsedProgress$=this._attributeChanges$.pipe(F(([e])=>e==="progress"),$(([e,r])=>r),Y(this.getAttribute("progress")),$(e=>e===null?null:Number(e)),F(e=>e===null||Number.isInteger(e)&&Number.isFinite(e)&&e<=100&&e>=0)),this._parsedDisabled$=this._attributeChanges$.pipe(F(([e])=>e==="disabled"),$(([e,r])=>r),Y(this.getAttribute("disabled")),$(e=>e!==null&&e!=="false")),this._parsedIndeterminateProgress$=this._attributeChanges$.pipe(F(([e])=>e==="indeterminate-progress"),$(([e,r])=>r),Y(this.getAttribute("indeterminate-progress")),$(e=>e!==null&&e!=="false")),this._parsedIndeterminateDurationMs$=this._attributeChanges$.pipe(F(([e])=>e==="indeterminate-duration-ms"),$(([e,r])=>r),Y(this.getAttribute("indeterminate-duration-ms")),$(e=>e===null?null:Number(e)),F(e=>e===null||Number.isInteger(e)&&Number.isFinite(e)&&e>=0)),this._indeterminedLoadingAt$=this._parsedIndeterminateProgress$.pipe(Y(!1),Pe(),F(([e,r])=>r&&!e),$(()=>Date.now()),Y(0)),this._loading$=this._parsedProgress$.pipe(yt(this._indeterminedLoadingAt$,this._parsedIndeterminateDurationMs$,this._parsedIndeterminateProgress$),Zi(([e,r,o,i])=>{const s=o!==null?o-Le>Date.now()-r:!1;return o!==null&&s?Ni(100).pipe($(()=>{const a=Date.now()-r,l=o-Le,f=Math.max(l,0),c=Math.ceil(a/f*100);return Math.min(100,c)}),Ki(u=>u<100,!0)):_t(i?0:e||0)}),Ce()),this._activeIndeterminateProgress$=this._parsedIndeterminateProgress$.pipe(yt(this._loading$,this._indeterminedLoadingAt$,this._parsedIndeterminateDurationMs$),Bi(([e,r,o,i])=>{const s=e&&r===100;if(!s){const u=i?i-(Date.now()-o):0;return console.log("timeLeft",u),_t(s).pipe(qi(u))}return _t(s)}),Ce()),this._disabled$=this._parsedDisabled$.pipe(yt(this._activeIndeterminateProgress$,this._loading$),$(([e,r,o])=>e||r||o>0&&o<100)),this._loadingBarTransitionEnabled$=this._loading$.pipe(Pe(),$(([e,r])=>r>=e),Y(!1)),this._parsedProgress$.subscribe(e=>console.log("parsedProgress",e)),this._parsedDisabled$.subscribe(e=>console.log("parsedDisabled",e)),this._parsedIndeterminateProgress$.subscribe(e=>console.log("parsedIndeterminateProgress",e)),this._parsedIndeterminateDurationMs$.subscribe(e=>console.log("parsedIndeterminateDurationMs",e)),this._indeterminedLoadingAt$.subscribe(e=>console.log("indeterminedLoadingAt",e)),this._loading$.subscribe(e=>console.log("loading",e)),this._activeIndeterminateProgress$.subscribe(e=>console.log("activeIndeterminateProgress",e)),this._disabled$.subscribe(e=>console.log("disabled",e)),this._loadingBarTransitionEnabled$.subscribe(e=>console.log("loadingBarTransitionEnabled",e))}static get observedAttributes(){return["progress","disabled","indeterminate-progress","indeterminate-duration-ms"]}async connectedCallback(){this.attachShadow({mode:"open"}),R(this).appendChild($o.content.cloneNode(!0)),this._renderSubscription=this._disabled$.pipe(yt(this._loading$,this._activeIndeterminateProgress$,this._loadingBarTransitionEnabled$)).subscribe(r=>{console.log("render"),this.render(...r)})}attributeChangedCallback(e){this._attributeChanges$.next([e,this.getAttribute(e)])}render(e,r,o,i){if(!this.shadowRoot)return;const s=R(this),u=C(s,"#progress"),a=C(s,"button");a instanceof HTMLButtonElement&&(a.disabled=e),o?(a.classList.remove("indeterminate-loading-end"),a.classList.add("indeterminate-loading")):(a.classList.add("indeterminate-loading-end"),setTimeout(()=>{a.classList.remove("indeterminate-loading")},500)),i?u.classList.add("transition"):u.classList.remove("transition"),u.style.width=`${r}%`}disconnectedCallback(){var e,r;(e=this._clickSubscription)==null||e.unsubscribe(),(r=this._renderSubscription)==null||r.unsubscribe()}}customElements.define(xo,So);const $o=ct(wo`
	<style>
		:host {
			display: inline-block;
		}
...
&lt;/crumbs-panel&gt;`);return j(un||(un=ls([`
	...
	`])))}var an,Wt=function(t,n){return Object.defineProperty?Object.defineProperty(t,"raw",{value:n}):t.raw=n,t};function bs(){var t=Pt(hr,mr),n=Pt(yr,gr),e=K(cn||(cn=Wt([`
		display: grid;
...
import "crumbs-design-system";
	...
	`])),bt,o,o,u,f,p,o,n,n,function(m){return e(m.originalTarget.value)},o,function(m){return i(String(m.target.value))},function(){return a(!u)},function(){return c(!f)},p,function(m){return h(Number(m.originalTarget.value))},{__html:b})}var dn;function ys(){const t=Pt(hr,mr),n=Pt(yr,gr),e=K`
