var tr=Object.defineProperty;var nr=(t,n,e)=>n in t?tr(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var $=(t,n,e)=>nr(t,typeof n!="symbol"?n+"":n,e);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function e(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(i){if(i.ep)return;i.ep=!0;const o=e(i);fetch(i.href,o)}})();function _t(t){for(var n,e,r=arguments,i=1,o="",s="",u=[0],a=function(l){i===1&&(l||(o=o.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?u.push(l?r[l]:o):i===3&&(l||o)?(u[1]=l?r[l]:o,i=2):i===2&&o==="..."&&l?u[2]=Object.assign(u[2]||{},r[l]):i===2&&o&&!l?(u[2]=u[2]||{})[o]=!0:i>=5&&(i===5?((u[2]=u[2]||{})[e]=l?o?o+r[l]:r[l]:o,i=6):(l||o)&&(u[2][e]+=l?o+r[l]:o)),o=""},c=0;c<t.length;c++){c&&(i===1&&a(),a(c));for(var f=0;f<t[c].length;f++)n=t[c][f],i===1?n==="<"?(a(),u=[u,"",null],i=3):o+=n:i===4?o==="--"&&n===">"?(i=1,o=""):o=n+o[0]:s?n===s?s="":o+=n:n==='"'||n==="'"?s=n:n===">"?(a(),i=1):i&&(n==="="?(i=5,e=o,o=""):n==="/"&&(i<5||t[c][f+1]===">")?(a(),i===3&&(u=u[0]),i=u,(u=u[0]).push(this.apply(null,i.slice(1))),i=0):n===" "||n==="	"||n===`
`||n==="\r"?(a(),i=2):o+=n),i===3&&o==="!--"&&(i=4,u=u[0])}return a(),u.length>2?u.slice(1):u[1]}function er(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}function rr(t){if(t.__esModule)return t;var n=t.default;if(typeof n=="function"){var e=function r(){return this instanceof r?Reflect.construct(n,arguments,this.constructor):n.apply(this,arguments)};e.prototype=n.prototype}else e={};return Object.defineProperty(e,"__esModule",{value:!0}),Object.keys(t).forEach(function(r){var i=Object.getOwnPropertyDescriptor(t,r);Object.defineProperty(e,r,i.get?i:{enumerable:!0,get:function(){return t[r]}})}),e}var Kn={exports:{}};/*!
 * Cross-Browser Split 1.1.1
 * Copyright 2007-2012 Steven Levithan <stevenlevithan.com>
 * Available under the MIT License
 * ECMAScript compliant, uniform cross-browser split method
 */var or=function(n){var e=String.prototype.split,r=/()??/.exec("")[1]===n,i;return i=function(o,l,u){if(Object.prototype.toString.call(l)!=="[object RegExp]")return e.call(o,l,u);var a=[],c=(l.ignoreCase?"i":"")+(l.multiline?"m":"")+(l.extended?"x":"")+(l.sticky?"y":""),f=0,l=new RegExp(l.source,c+"g"),d,p,m,b;for(o+="",r||(d=new RegExp("^"+l.source+"$(?!\\s)",c)),u=u===n?-1>>>0:u>>>0;(p=l.exec(o))&&(m=p.index+p[0].length,!(m>f&&(a.push(o.slice(f,p.index)),!r&&p.length>1&&p[0].replace(d,function(){for(var h=1;h<arguments.length-2;h++)arguments[h]===n&&(p[h]=n)}),p.length>1&&p.index<o.length&&Array.prototype.push.apply(a,p.slice(1)),b=p[0].length,f=m,a.length>=u)));)l.lastIndex===p.index&&l.lastIndex++;return f===o.length?(b||!l.test(""))&&a.push(""):a.push(o.slice(f)),a.length>u?a.slice(0,u):a},i}(),ir=[].indexOf,sr=function(t,n){if(ir)return t.indexOf(n);for(var e=0;e<t.length;++e)if(t[e]===n)return e;return-1},Tt=sr,ur=cr;function cr(t){var n=t.classList;if(n)return n;var e={add:r,remove:i,contains:o,toggle:s,toString:u,length:0,item:a};return e;function r(l){var d=c();Tt(d,l)>-1||(d.push(l),f(d))}function i(l){var d=c(),p=Tt(d,l);p!==-1&&(d.splice(p,1),f(d))}function o(l){return Tt(c(),l)>-1}function s(l){return o(l)?(i(l),!1):(r(l),!0)}function u(){return t.className}function a(l){var d=c();return d[l]||null}function c(){var l=t.className;return ar(l.split(" "),lr)}function f(l){var d=l.length;t.className=l.join(" "),e.length=d;for(var p=0;p<l.length;p++)e[p]=l[p];delete l[d]}}function ar(t,n){for(var e=[],r=0;r<t.length;r++)n(t[r])&&e.push(t[r]);return e}function lr(t){return!!t}const fr={},pr=Object.freeze(Object.defineProperty({__proto__:null,default:fr},Symbol.toStringTag,{value:"Module"})),dr=rr(pr);var br=or,mr=ur,Qn=typeof window>"u"?dr:window,G=Qn.document,hr=Qn.Text;function Zn(){var t=[];function n(){var e=[].slice.call(arguments),r=null;function i(o){var s;function u(l){var d=br(l,/([\.#]?[^\s#.]+)/);/^\.|#/.test(d[1])&&(r=G.createElement("div")),an(d,function(p){var m=p.substring(1,p.length);p&&(r?p[0]==="."?mr(r).add(m):p[0]==="#"&&r.setAttribute("id",m):r=G.createElement(p))})}if(o!=null){if(typeof o=="string")r?r.appendChild(s=G.createTextNode(o)):u(o);else if(typeof o=="number"||typeof o=="boolean"||o instanceof Date||o instanceof RegExp)r.appendChild(s=G.createTextNode(o.toString()));else if(_r(o))an(o,i);else if(Et(o))r.appendChild(s=o);else if(o instanceof hr)r.appendChild(s=o);else if(typeof o=="object")for(var a in o)if(typeof o[a]=="function")/^on\w+/.test(a)?function(l,d){r.addEventListener?(r.addEventListener(l.substring(2),d[l],!1),t.push(function(){r.removeEventListener(l.substring(2),d[l],!1)})):(r.attachEvent(l,d[l]),t.push(function(){r.detachEvent(l,d[l])}))}(a,o):(r[a]=o[a](),t.push(o[a](function(l){r[a]=l})));else if(a==="style")if(typeof o[a]=="string")r.style.cssText=o[a];else for(var c in o[a])(function(l,d){if(typeof d=="function")r.style.setProperty(l,d()),t.push(d(function(m){r.style.setProperty(l,m)}));else var p=o[a][l].match(/(.*)\W+!important\W*$/);p?r.style.setProperty(l,p[1],"important"):r.style.setProperty(l,o[a][l])})(c,o[a][c]);else if(a==="attrs")for(var f in o[a])r.setAttribute(f,o[a][f]);else a.substr(0,5)==="data-"?r.setAttribute(a,o[a]):r[a]=o[a];else if(typeof o=="function"){var f=o();r.appendChild(s=Et(f)?f:G.createTextNode(f)),t.push(o(function(d){Et(d)&&s.parentElement?(s.parentElement.replaceChild(d,s),s=d):s.textContent=d}))}}return s}for(;e.length;)i(e.shift());return r}return n.cleanup=function(){for(var e=0;e<t.length;e++)t[e]();t.length=0},n}var vr=Kn.exports=Zn();vr.context=Zn;function Et(t){return t&&t.nodeName&&t.nodeType}function an(t,n){if(t.forEach)return t.forEach(n);for(var e=0;e<t.length;e++)n(t[e],e)}function _r(t){return Object.prototype.toString.call(t)=="[object Array]"}var yr=Kn.exports;const tt=er(yr);function C(t){if(!t.shadowRoot)throw new Error("There is no shadow root on the element !");return t.shadowRoot}function nt(t){const n=Array.isArray(t)?t:[t],e=document.createElement("template");return e.innerHTML=n.map(r=>r.outerHTML).join(""),e}var At=function(t,n){return At=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,r){e.__proto__=r}||function(e,r){for(var i in r)Object.prototype.hasOwnProperty.call(r,i)&&(e[i]=r[i])},At(t,n)};function Yt(t,n){if(typeof n!="function"&&n!==null)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null");At(t,n);function e(){this.constructor=t}t.prototype=n===null?Object.create(n):(e.prototype=n.prototype,new e)}function gr(t,n,e,r){function i(o){return o instanceof e?o:new e(function(s){s(o)})}return new(e||(e=Promise))(function(o,s){function u(f){try{c(r.next(f))}catch(l){s(l)}}function a(f){try{c(r.throw(f))}catch(l){s(l)}}function c(f){f.done?o(f.value):i(f.value).then(u,a)}c((r=r.apply(t,n||[])).next())})}function Xn(t,n){var e={label:0,sent:function(){if(o[0]&1)throw o[1];return o[1]},trys:[],ops:[]},r,i,o,s;return s={next:u(0),throw:u(1),return:u(2)},typeof Symbol=="function"&&(s[Symbol.iterator]=function(){return this}),s;function u(c){return function(f){return a([c,f])}}function a(c){if(r)throw new TypeError("Generator is already executing.");for(;s&&(s=0,c[0]&&(e=0)),e;)try{if(r=1,i&&(o=c[0]&2?i.return:c[0]?i.throw||((o=i.return)&&o.call(i),0):i.next)&&!(o=o.call(i,c[1])).done)return o;switch(i=0,o&&(c=[c[0]&2,o.value]),c[0]){case 0:case 1:o=c;break;case 4:return e.label++,{value:c[1],done:!1};case 5:e.label++,i=c[1],c=[0];continue;case 7:c=e.ops.pop(),e.trys.pop();continue;default:if(o=e.trys,!(o=o.length>0&&o[o.length-1])&&(c[0]===6||c[0]===2)){e=0;continue}if(c[0]===3&&(!o||c[1]>o[0]&&c[1]<o[3])){e.label=c[1];break}if(c[0]===6&&e.label<o[1]){e.label=o[1],o=c;break}if(o&&e.label<o[2]){e.label=o[2],e.ops.push(c);break}o[2]&&e.ops.pop(),e.trys.pop();continue}c=n.call(t,e)}catch(f){c=[6,f],i=0}finally{r=o=0}if(c[0]&5)throw c[1];return{value:c[0]?c[1]:void 0,done:!0}}}function J(t){var n=typeof Symbol=="function"&&Symbol.iterator,e=n&&t[n],r=0;if(e)return e.call(t);if(t&&typeof t.length=="number")return{next:function(){return t&&r>=t.length&&(t=void 0),{value:t&&t[r++],done:!t}}};throw new TypeError(n?"Object is not iterable.":"Symbol.iterator is not defined.")}function K(t,n){var e=typeof Symbol=="function"&&t[Symbol.iterator];if(!e)return t;var r=e.call(t),i,o=[],s;try{for(;(n===void 0||n-- >0)&&!(i=r.next()).done;)o.push(i.value)}catch(u){s={error:u}}finally{try{i&&!i.done&&(e=r.return)&&e.call(r)}finally{if(s)throw s.error}}return o}function mt(t,n,e){if(e||arguments.length===2)for(var r=0,i=n.length,o;r<i;r++)(o||!(r in n))&&(o||(o=Array.prototype.slice.call(n,0,r)),o[r]=n[r]);return t.concat(o||Array.prototype.slice.call(n))}function W(t){return this instanceof W?(this.v=t,this):new W(t)}function wr(t,n,e){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var r=e.apply(t,n||[]),i,o=[];return i={},u("next"),u("throw"),u("return",s),i[Symbol.asyncIterator]=function(){return this},i;function s(p){return function(m){return Promise.resolve(m).then(p,l)}}function u(p,m){r[p]&&(i[p]=function(b){return new Promise(function(h,v){o.push([p,b,h,v])>1||a(p,b)})},m&&(i[p]=m(i[p])))}function a(p,m){try{c(r[p](m))}catch(b){d(o[0][3],b)}}function c(p){p.value instanceof W?Promise.resolve(p.value.v).then(f,l):d(o[0][2],p)}function f(p){a("next",p)}function l(p){a("throw",p)}function d(p,m){p(m),o.shift(),o.length&&a(o[0][0],o[0][1])}}function xr(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var n=t[Symbol.asyncIterator],e;return n?n.call(t):(t=typeof J=="function"?J(t):t[Symbol.iterator](),e={},r("next"),r("throw"),r("return"),e[Symbol.asyncIterator]=function(){return this},e);function r(o){e[o]=t[o]&&function(s){return new Promise(function(u,a){s=t[o](s),i(u,a,s.done,s.value)})}}function i(o,s,u,a){Promise.resolve(a).then(function(c){o({value:c,done:u})},s)}}function _(t){return typeof t=="function"}function te(t){var n=function(r){Error.call(r),r.stack=new Error().stack},e=t(n);return e.prototype=Object.create(Error.prototype),e.prototype.constructor=e,e}var $t=te(function(t){return function(e){t(this),this.message=e?e.length+` errors occurred during unsubscription:
`+e.map(function(r,i){return i+1+") "+r.toString()}).join(`
  `):"",this.name="UnsubscriptionError",this.errors=e}});function ln(t,n){if(t){var e=t.indexOf(n);0<=e&&t.splice(e,1)}}var Gt=function(){function t(n){this.initialTeardown=n,this.closed=!1,this._parentage=null,this._finalizers=null}return t.prototype.unsubscribe=function(){var n,e,r,i,o;if(!this.closed){this.closed=!0;var s=this._parentage;if(s)if(this._parentage=null,Array.isArray(s))try{for(var u=J(s),a=u.next();!a.done;a=u.next()){var c=a.value;c.remove(this)}}catch(b){n={error:b}}finally{try{a&&!a.done&&(e=u.return)&&e.call(u)}finally{if(n)throw n.error}}else s.remove(this);var f=this.initialTeardown;if(_(f))try{f()}catch(b){o=b instanceof $t?b.errors:[b]}var l=this._finalizers;if(l){this._finalizers=null;try{for(var d=J(l),p=d.next();!p.done;p=d.next()){var m=p.value;try{fn(m)}catch(b){o=o??[],b instanceof $t?o=mt(mt([],K(o)),K(b.errors)):o.push(b)}}}catch(b){r={error:b}}finally{try{p&&!p.done&&(i=d.return)&&i.call(d)}finally{if(r)throw r.error}}}if(o)throw new $t(o)}},t.prototype.add=function(n){var e;if(n&&n!==this)if(this.closed)fn(n);else{if(n instanceof t){if(n.closed||n._hasParent(this))return;n._addParent(this)}(this._finalizers=(e=this._finalizers)!==null&&e!==void 0?e:[]).push(n)}},t.prototype._hasParent=function(n){var e=this._parentage;return e===n||Array.isArray(e)&&e.includes(n)},t.prototype._addParent=function(n){var e=this._parentage;this._parentage=Array.isArray(e)?(e.push(n),e):e?[e,n]:n},t.prototype._removeParent=function(n){var e=this._parentage;e===n?this._parentage=null:Array.isArray(e)&&ln(e,n)},t.prototype.remove=function(n){var e=this._finalizers;e&&ln(e,n),n instanceof t&&n._removeParent(this)},t.EMPTY=function(){var n=new t;return n.closed=!0,n}(),t}();Gt.EMPTY;function ne(t){return t instanceof Gt||t&&"closed"in t&&_(t.remove)&&_(t.add)&&_(t.unsubscribe)}function fn(t){_(t)?t():t.unsubscribe()}var ee={onUnhandledError:null,onStoppedNotification:null,Promise:void 0,useDeprecatedSynchronousErrorHandling:!1,useDeprecatedNextContext:!1},re={setTimeout:function(t,n){for(var e=[],r=2;r<arguments.length;r++)e[r-2]=arguments[r];return setTimeout.apply(void 0,mt([t,n],K(e)))},clearTimeout:function(t){var n=re.delegate;return((n==null?void 0:n.clearTimeout)||clearTimeout)(t)},delegate:void 0};function oe(t){re.setTimeout(function(){throw t})}function pn(){}function Sr(t){t()}var Jt=function(t){Yt(n,t);function n(e){var r=t.call(this)||this;return r.isStopped=!1,e?(r.destination=e,ne(e)&&e.add(r)):r.destination=kr,r}return n.create=function(e,r,i){return new Lt(e,r,i)},n.prototype.next=function(e){this.isStopped||this._next(e)},n.prototype.error=function(e){this.isStopped||(this.isStopped=!0,this._error(e))},n.prototype.complete=function(){this.isStopped||(this.isStopped=!0,this._complete())},n.prototype.unsubscribe=function(){this.closed||(this.isStopped=!0,t.prototype.unsubscribe.call(this),this.destination=null)},n.prototype._next=function(e){this.destination.next(e)},n.prototype._error=function(e){try{this.destination.error(e)}finally{this.unsubscribe()}},n.prototype._complete=function(){try{this.destination.complete()}finally{this.unsubscribe()}},n}(Gt),Tr=Function.prototype.bind;function kt(t,n){return Tr.call(t,n)}var Er=function(){function t(n){this.partialObserver=n}return t.prototype.next=function(n){var e=this.partialObserver;if(e.next)try{e.next(n)}catch(r){ut(r)}},t.prototype.error=function(n){var e=this.partialObserver;if(e.error)try{e.error(n)}catch(r){ut(r)}else ut(n)},t.prototype.complete=function(){var n=this.partialObserver;if(n.complete)try{n.complete()}catch(e){ut(e)}},t}(),Lt=function(t){Yt(n,t);function n(e,r,i){var o=t.call(this)||this,s;if(_(e)||!e)s={next:e??void 0,error:r??void 0,complete:i??void 0};else{var u;o&&ee.useDeprecatedNextContext?(u=Object.create(e),u.unsubscribe=function(){return o.unsubscribe()},s={next:e.next&&kt(e.next,u),error:e.error&&kt(e.error,u),complete:e.complete&&kt(e.complete,u)}):s=e}return o.destination=new Er(s),o}return n}(Jt);function ut(t){oe(t)}function $r(t){throw t}var kr={closed:!0,next:pn,error:$r,complete:pn},Kt=function(){return typeof Symbol=="function"&&Symbol.observable||"@@observable"}();function et(t){return t}function Ir(t){return t.length===0?et:t.length===1?t[0]:function(e){return t.reduce(function(r,i){return i(r)},e)}}var E=function(){function t(n){n&&(this._subscribe=n)}return t.prototype.lift=function(n){var e=new t;return e.source=this,e.operator=n,e},t.prototype.subscribe=function(n,e,r){var i=this,o=Pr(n)?n:new Lt(n,e,r);return Sr(function(){var s=i,u=s.operator,a=s.source;o.add(u?u.call(o,a):a?i._subscribe(o):i._trySubscribe(o))}),o},t.prototype._trySubscribe=function(n){try{return this._subscribe(n)}catch(e){n.error(e)}},t.prototype.forEach=function(n,e){var r=this;return e=dn(e),new e(function(i,o){var s=new Lt({next:function(u){try{n(u)}catch(a){o(a),s.unsubscribe()}},error:o,complete:i});r.subscribe(s)})},t.prototype._subscribe=function(n){var e;return(e=this.source)===null||e===void 0?void 0:e.subscribe(n)},t.prototype[Kt]=function(){return this},t.prototype.pipe=function(){for(var n=[],e=0;e<arguments.length;e++)n[e]=arguments[e];return Ir(n)(this)},t.prototype.toPromise=function(n){var e=this;return n=dn(n),new n(function(r,i){var o;e.subscribe(function(s){return o=s},function(s){return i(s)},function(){return r(o)})})},t.create=function(n){return new t(n)},t}();function dn(t){var n;return(n=t??ee.Promise)!==null&&n!==void 0?n:Promise}function Or(t){return t&&_(t.next)&&_(t.error)&&_(t.complete)}function Pr(t){return t&&t instanceof Jt||Or(t)&&ne(t)}function Cr(t){return _(t==null?void 0:t.lift)}function N(t){return function(n){if(Cr(n))return n.lift(function(e){try{return t(e,this)}catch(r){this.error(r)}});throw new TypeError("Unable to lift unknown Observable type")}}function j(t,n,e,r,i){return new jr(t,n,e,r,i)}var jr=function(t){Yt(n,t);function n(e,r,i,o,s,u){var a=t.call(this,e)||this;return a.onFinalize=s,a.shouldUnsubscribe=u,a._next=r?function(c){try{r(c)}catch(f){e.error(f)}}:t.prototype._next,a._error=o?function(c){try{o(c)}catch(f){e.error(f)}finally{this.unsubscribe()}}:t.prototype._error,a._complete=i?function(){try{i()}catch(c){e.error(c)}finally{this.unsubscribe()}}:t.prototype._complete,a}return n.prototype.unsubscribe=function(){var e;if(!this.shouldUnsubscribe||this.shouldUnsubscribe()){var r=this.closed;t.prototype.unsubscribe.call(this),!r&&((e=this.onFinalize)===null||e===void 0||e.call(this))}},n}(Jt),ie=new E(function(t){return t.complete()});function Ar(t){return t&&_(t.schedule)}function Qt(t){return t[t.length-1]}function Lr(t){return _(Qt(t))?t.pop():void 0}function se(t){return Ar(Qt(t))?t.pop():void 0}function Mr(t,n){return typeof Qt(t)=="number"?t.pop():n}var Zt=function(t){return t&&typeof t.length=="number"&&typeof t!="function"};function ue(t){return _(t==null?void 0:t.then)}function ce(t){return _(t[Kt])}function ae(t){return Symbol.asyncIterator&&_(t==null?void 0:t[Symbol.asyncIterator])}function le(t){return new TypeError("You provided "+(t!==null&&typeof t=="object"?"an invalid object":"'"+t+"'")+" where a stream was expected. You can provide an Observable, Promise, ReadableStream, Array, AsyncIterable, or Iterable.")}function Hr(){return typeof Symbol!="function"||!Symbol.iterator?"@@iterator":Symbol.iterator}var fe=Hr();function pe(t){return _(t==null?void 0:t[fe])}function de(t){return wr(this,arguments,function(){var e,r,i,o;return Xn(this,function(s){switch(s.label){case 0:e=t.getReader(),s.label=1;case 1:s.trys.push([1,,9,10]),s.label=2;case 2:return[4,W(e.read())];case 3:return r=s.sent(),i=r.value,o=r.done,o?[4,W(void 0)]:[3,5];case 4:return[2,s.sent()];case 5:return[4,W(i)];case 6:return[4,s.sent()];case 7:return s.sent(),[3,2];case 8:return[3,10];case 9:return e.releaseLock(),[7];case 10:return[2]}})})}function be(t){return _(t==null?void 0:t.getReader)}function V(t){if(t instanceof E)return t;if(t!=null){if(ce(t))return Nr(t);if(Zt(t))return Fr(t);if(ue(t))return Rr(t);if(ae(t))return me(t);if(pe(t))return Ur(t);if(be(t))return Dr(t)}throw le(t)}function Nr(t){return new E(function(n){var e=t[Kt]();if(_(e.subscribe))return e.subscribe(n);throw new TypeError("Provided object does not correctly implement Symbol.observable")})}function Fr(t){return new E(function(n){for(var e=0;e<t.length&&!n.closed;e++)n.next(t[e]);n.complete()})}function Rr(t){return new E(function(n){t.then(function(e){n.closed||(n.next(e),n.complete())},function(e){return n.error(e)}).then(null,oe)})}function Ur(t){return new E(function(n){var e,r;try{for(var i=J(t),o=i.next();!o.done;o=i.next()){var s=o.value;if(n.next(s),n.closed)return}}catch(u){e={error:u}}finally{try{o&&!o.done&&(r=i.return)&&r.call(i)}finally{if(e)throw e.error}}n.complete()})}function me(t){return new E(function(n){zr(t,n).catch(function(e){return n.error(e)})})}function Dr(t){return me(de(t))}function zr(t,n){var e,r,i,o;return gr(this,void 0,void 0,function(){var s,u;return Xn(this,function(a){switch(a.label){case 0:a.trys.push([0,5,6,11]),e=xr(t),a.label=1;case 1:return[4,e.next()];case 2:if(r=a.sent(),!!r.done)return[3,4];if(s=r.value,n.next(s),n.closed)return[2];a.label=3;case 3:return[3,1];case 4:return[3,11];case 5:return u=a.sent(),i={error:u},[3,11];case 6:return a.trys.push([6,,9,10]),r&&!r.done&&(o=e.return)?[4,o.call(e)]:[3,8];case 7:a.sent(),a.label=8;case 8:return[3,10];case 9:if(i)throw i.error;return[7];case 10:return[7];case 11:return n.complete(),[2]}})})}function M(t,n,e,r,i){r===void 0&&(r=0),i===void 0&&(i=!1);var o=n.schedule(function(){e(),i?t.add(this.schedule(null,r)):this.unsubscribe()},r);if(t.add(o),!i)return o}function he(t,n){return n===void 0&&(n=0),N(function(e,r){e.subscribe(j(r,function(i){return M(r,t,function(){return r.next(i)},n)},function(){return M(r,t,function(){return r.complete()},n)},function(i){return M(r,t,function(){return r.error(i)},n)}))})}function ve(t,n){return n===void 0&&(n=0),N(function(e,r){r.add(t.schedule(function(){return e.subscribe(r)},n))})}function Vr(t,n){return V(t).pipe(ve(n),he(n))}function Br(t,n){return V(t).pipe(ve(n),he(n))}function Wr(t,n){return new E(function(e){var r=0;return n.schedule(function(){r===t.length?e.complete():(e.next(t[r++]),e.closed||this.schedule())})})}function qr(t,n){return new E(function(e){var r;return M(e,n,function(){r=t[fe](),M(e,n,function(){var i,o,s;try{i=r.next(),o=i.value,s=i.done}catch(u){e.error(u);return}s?e.complete():e.next(o)},0,!0)}),function(){return _(r==null?void 0:r.return)&&r.return()}})}function _e(t,n){if(!t)throw new Error("Iterable cannot be null");return new E(function(e){M(e,n,function(){var r=t[Symbol.asyncIterator]();M(e,n,function(){r.next().then(function(i){i.done?e.complete():e.next(i.value)})},0,!0)})})}function Yr(t,n){return _e(de(t),n)}function Gr(t,n){if(t!=null){if(ce(t))return Vr(t,n);if(Zt(t))return Wr(t,n);if(ue(t))return Br(t,n);if(ae(t))return _e(t,n);if(pe(t))return qr(t,n);if(be(t))return Yr(t,n)}throw le(t)}function Xt(t,n){return n?Gr(t,n):V(t)}var ye=te(function(t){return function(){t(this),this.name="EmptyError",this.message="no elements in sequence"}});function q(t,n){return N(function(e,r){var i=0;e.subscribe(j(r,function(o){r.next(t.call(n,o,i++))}))})}var Jr=Array.isArray;function Kr(t,n){return Jr(n)?t.apply(void 0,mt([],K(n))):t(n)}function ge(t){return q(function(n){return Kr(t,n)})}var Qr=Array.isArray,Zr=Object.getPrototypeOf,Xr=Object.prototype,to=Object.keys;function no(t){if(t.length===1){var n=t[0];if(Qr(n))return{args:n,keys:null};if(eo(n)){var e=to(n);return{args:e.map(function(r){return n[r]}),keys:e}}}return{args:t,keys:null}}function eo(t){return t&&typeof t=="object"&&Zr(t)===Xr}function ro(t,n){return t.reduce(function(e,r,i){return e[r]=n[i],e},{})}function oo(){for(var t=[],n=0;n<arguments.length;n++)t[n]=arguments[n];var e=se(t),r=Lr(t),i=no(t),o=i.args,s=i.keys;if(o.length===0)return Xt([],e);var u=new E(io(o,e,s?function(a){return ro(s,a)}:et));return r?u.pipe(ge(r)):u}function io(t,n,e){return e===void 0&&(e=et),function(r){bn(n,function(){for(var i=t.length,o=new Array(i),s=i,u=i,a=function(f){bn(n,function(){var l=Xt(t[f],n),d=!1;l.subscribe(j(r,function(p){o[f]=p,d||(d=!0,u--),u||r.next(e(o.slice()))},function(){--s||r.complete()}))},r)},c=0;c<i;c++)a(c)},r)}}function bn(t,n,e){t?M(e,t,n):n()}function so(t,n,e,r,i,o,s,u){var a=[],c=0,f=0,l=!1,d=function(){l&&!a.length&&!c&&n.complete()},p=function(b){return c<r?m(b):a.push(b)},m=function(b){c++;var h=!1;V(e(b,f++)).subscribe(j(n,function(v){n.next(v)},function(){h=!0},void 0,function(){if(h)try{c--;for(var v=function(){var y=a.shift();s||m(y)};a.length&&c<r;)v();d()}catch(y){n.error(y)}}))};return t.subscribe(j(n,p,function(){l=!0,d()})),function(){}}function tn(t,n,e){return e===void 0&&(e=1/0),_(n)?tn(function(r,i){return q(function(o,s){return n(r,o,i,s)})(V(t(r,i)))},e):(typeof n=="number"&&(e=n),N(function(r,i){return so(r,i,t,e)}))}function uo(t){return t===void 0&&(t=1/0),tn(et,t)}var co=["addListener","removeListener"],ao=["addEventListener","removeEventListener"],lo=["on","off"];function H(t,n,e,r){if(_(e)&&(r=e,e=void 0),r)return H(t,n,e).pipe(ge(r));var i=K(bo(t)?ao.map(function(u){return function(a){return t[u](n,a,e)}}):fo(t)?co.map(mn(t,n)):po(t)?lo.map(mn(t,n)):[],2),o=i[0],s=i[1];if(!o&&Zt(t))return tn(function(u){return H(u,n,e)})(V(t));if(!o)throw new TypeError("Invalid event target");return new E(function(u){var a=function(){for(var c=[],f=0;f<arguments.length;f++)c[f]=arguments[f];return u.next(1<c.length?c:c[0])};return o(a),function(){return s(a)}})}function mn(t,n){return function(e){return function(r){return t[e](n,r)}}}function fo(t){return _(t.addListener)&&_(t.removeListener)}function po(t){return _(t.on)&&_(t.off)}function bo(t){return _(t.addEventListener)&&_(t.removeEventListener)}function mo(){for(var t=[],n=0;n<arguments.length;n++)t[n]=arguments[n];var e=se(t),r=Mr(t,1/0),i=t;return i.length?i.length===1?V(i[0]):uo(r)(Xt(i,e)):ie}function ho(t,n){return N(function(e,r){var i=0;e.subscribe(j(r,function(o){return t.call(n,o,i++)&&r.next(o)}))})}function vo(t){return N(function(n,e){var r=!1;n.subscribe(j(e,function(i){r=!0,e.next(i)},function(){r||e.next(t),e.complete()}))})}function _o(t){return t<=0?function(){return ie}:N(function(n,e){var r=0;n.subscribe(j(e,function(i){++r<=t&&(e.next(i),t<=r&&e.complete())}))})}function hn(t){return q(function(){return t})}function yo(t){return t===void 0&&(t=go),N(function(n,e){var r=!1;n.subscribe(j(e,function(i){r=!0,e.next(i)},function(){return r?e.complete():e.error(t())}))})}function go(){return new ye}function wo(t,n){var e=arguments.length>=2;return function(r){return r.pipe(et,_o(1),e?vo(n):yo(function(){return new ye}))}}function we(){return!document.hidden}function xo(){const t=H(document,"visibilitychange"),n=H(window,"focus").pipe(hn(!0)),e=H(window,"blur").pipe(hn(!1)),r=mo(n,e);return oo(t,r).pipe(q(([,i])=>we()&&i),ho(i=>i),wo())}const So=H(document,"mouseover");async function To(){we()||await Promise.race([xo().toPromise(),So.toPromise()])}async function Eo(){await new Promise(t=>setTimeout(t,400)),await To(),await new Promise(t=>setTimeout(t,400))}const $o=Eo();function I(t,n){const e=t.querySelector(n);if(!e)throw new Error("Failed to find element ${ selector } !");return e}const ko=_t.bind(tt),Io="crumbs-p",Oo=nt(ko`
	<style>
		:host {
			display: block;
		}
...
`);let Po=class extends HTMLElement{async connectedCallback(){this.attachShadow({mode:"open"});const n=C(this),e=Oo.content.cloneNode(!0);n.appendChild(e)}};customElements.define(Io,Po);const Co=_t.bind(tt),jo="crumbs-panel",Ao=nt(Co`
	<style>
		:host {
			display: block;
		}
...
`);class Lo extends HTMLElement{constructor(){super(...arguments);$(this,"contentTimeoutElapsed",!1);$(this,"contentLoaded",!1);$(this,"connected",!1);$(this,"loading","100");$(this,"scrolled",!1);$(this,"scrolledSubscription",null)}static get observedAttributes(){return["panel-loading","panel-title"]}async connectedCallback(){this.attachShadow({mode:"open"}),await $o;const e=C(this),r=Ao.content.cloneNode(!0);e.appendChild(r);const i=this.getAttribute("panel-loading");i!==null&&vn(i)&&(this.loading=i),setTimeout(()=>{const o=I(e,"#panel-container");o.style.gridTemplateColumns="1rem 1fr 1rem",o.style.gridTemplateRows="1rem 1fr 1rem";const s=I(e,"#panel");s.style.backgroundColor="#ffffff40",this.scrolledSubscription=H(s,"scroll").pipe(q(u=>u.target.scrollTop),q(u=>u!==0)).subscribe(u=>{this.scrolled=u,this.render()}),this.render()},10),setTimeout(()=>{this.contentTimeoutElapsed=!0,this.render()},400),this.connected=!0,this.render()}render(){const e=C(this),r=I(e,"#panel-content"),i=I(e,"#panel-loading"),o=I(e,"#panel"),s=I(e,"#panel-title-content");this.contentTimeoutElapsed&&Mo(this.loading)?(r.style.visibility="visible",r.style.opacity="1",o.style.overflow="auto"):(r.style.visibility="collapse",r.style.opacity="0",o.style.overflow="hidden"),i.style.width=`${this.loading}%`;const u=I(e,"#panel-title");this.loading==="100"&&this.getAttribute("panel-title")&&!this.scrolled?setTimeout(()=>{u.style.opacity="1",s.innerHTML=this.getAttribute("panel-title")||"",r.style.paddingTop="2.5rem"},10):(r.style.paddingTop="inherit",u.style.opacity="0")}attributeChangedCallback(){if(this.shadowRoot&&this.connected){const e=this.getAttribute("panel-loading");e!==null&&vn(e)?this.loading=e:e===null&&(this.loading="100"),this.render()}}disconnectedCallback(){var e;(e=this.scrolledSubscription)==null||e.unsubscribe()}}function vn(t){const n=Number(t),e=Math.floor(n);return e===n&&Number.isInteger(e)&&Number.isFinite(e)&&e<=100&&e>=0}function Mo(t){return t===null||t==="100"}customElements.define(jo,Lo);const Ho=_t.bind(tt),No="crumbs-input",Fo=nt(Ho`
	...
	<input type="text"/>
`);class Ro extends HTMLElement{static get observedAttributes(){return["value"]}async connectedCallback(){this.attachShadow({mode:"open"});const n=C(this),e=Fo.content.cloneNode(!0);n.appendChild(e);const r=I(n,"input"),i=this.getAttribute("value");r instanceof HTMLInputElement&&i&&(r.value=i)}attributeChangedCallback(n,e,r){if(n==="value"&&this.shadowRoot){const i=C(this),o=I(i,"input");o instanceof HTMLInputElement&&(o.value=r)}}}customElements.define(No,Ro);const Mt=_t.bind(tt),Uo="crumbs-tabs",Do=nt(Mt`
	<style>
		:host {
			display: block;
		}
...
`],[`
	...
	display: grid;
	place-content: center;
`])));function rt(t){var n=t.title,e=t.children;return k(Rn||(Rn=Xe([`
...
&lt;/crumbs-panel&gt;`);return k(Vn||(Vn=ji([`
	...
	`])))}var Bn,jt=function(t,n){return Object.defineProperty?Object.defineProperty(t,"raw",{value:n}):t.raw=n,t};function Hi(){var t=vt(Ye,Ge),n=vt(Qe,Ze),e=D(Wn||(Wn=jt([`
		display: grid;
...
import "crumbs-design-system";
	...
	`])),rt,o,o,o,e,e,function(p){return r(p.originalTarget.value)},o,function(p){return s(String(p.target.value))},l,{__html:d})}var Jn;function Vi(){const t=vt(Ye,Ge),n=vt(Qe,Ze),e=D`
