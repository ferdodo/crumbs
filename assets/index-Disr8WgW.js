...
`);class Ao extends HTMLElement{constructor(){super(...arguments);E(this,"contentTimeoutElapsed",!1);E(this,"contentLoaded",!1);E(this,"connected",!1);E(this,"loading","100");E(this,"scrolled",!1);E(this,"scrolledSubscription",null)}static get observedAttributes(){return["panel-loading","panel-title"]}async connectedCallback(){this.attachShadow({mode:"open"}),await Eo;const e=C(this),r=jo.content.cloneNode(!0);e.appendChild(r);const i=this.getAttribute("panel-loading");i!==null&&vn(i)&&(this.loading=i),setTimeout(()=>{const o=k(e,"#panel-container");o.style.gridTemplateColumns="1rem 1fr 1rem",o.style.gridTemplateRows="1rem 1fr 1rem";const s=k(e,"#panel");s.style.backgroundColor="#ffffff40",this.scrolledSubscription=H(s,"scroll").pipe(q(u=>u.target.scrollTop),q(u=>u!==0)).subscribe(u=>{this.scrolled=u,this.render()}),this.render()},10),setTimeout(()=>{this.contentTimeoutElapsed=!0,this.render()},400),this.connected=!0,this.render()}render(){const e=C(this),r=k(e,"#panel-content"),i=k(e,"#panel-loading"),o=k(e,"#panel"),s=k(e,"#panel-title-content");this.contentTimeoutElapsed&&Lo(this.loading)?(r.style.visibility="visible",r.style.opacity="1",o.style.overflow="auto"):(r.style.visibility="collapse",r.style.opacity="0",o.style.overflow="hidden"),i.style.width=`${this.loading}%`;const u=k(e,"#panel-title");this.loading==="100"&&this.getAttribute("panel-title")&&!this.scrolled?setTimeout(()=>{u.style.opacity="1",s.innerHTML=this.getAttribute("panel-title")||"",r.style.paddingTop="2.5rem"},10):(r.style.paddingTop="inherit",u.style.opacity="0")}attributeChangedCallback(){if(this.shadowRoot&&this.connected){const e=this.getAttribute("panel-loading");e!==null&&vn(e)?this.loading=e:e===null&&(this.loading="100"),this.render()}}disconnectedCallback(){var e;(e=this.scrolledSubscription)==null||e.unsubscribe()}}function vn(t){const n=Number(t),e=Math.floor(n);return e===n&&Number.isInteger(e)&&Number.isFinite(e)&&e<=100&&e>=0}function Lo(t){return t===null||t==="100"}customElements.define(Co,Ao);const Mo=_t.bind(tt),Ho="crumbs-input",No=nt(Mo`
	<style>
		:host {
			display: block;
		}
	...
	<input type="text"/>
`);class Fo extends HTMLElement{static get observedAttributes(){return["value"]}async connectedCallback(){this.attachShadow({mode:"open"});const n=C(this),e=No.content.cloneNode(!0);n.appendChild(e);const r=k(n,"input"),i=this.getAttribute("value");r instanceof HTMLInputElement&&i&&(r.value=i)}attributeChangedCallback(n,e,r){if(n==="value"&&this.shadowRoot){const i=C(this),o=k(i,"input");o instanceof HTMLInputElement&&(o.value=r)}}}customElements.define(Ho,Fo);const Mt=_t.bind(tt),Ro="crumbs-tabs",Uo=nt(Mt`
	<style>
		:host {
			display: block;
		}
...
`],[`
	...
	display: grid;
	place-content: center;
`])));function rt(t){var n=t.title,e=t.children;return I(Rn||(Rn=Ze([`
	...
	value="`.concat(n,`"&gt;
&lt;/crumbs-input&gt;`);return I(Un||(Un=Ti([`
		<`,` title="Input">
			<crumbs-input
				value=`,`
				oninput=`,`
	...
	`])),rt,n,function(i){return e(i.originalTarget.value)},n,function(i){return e(i.originalTarget.value)},{__html:r})}var Un,$i=function(t,n){return Object.defineProperty?Object.defineProperty(t,"raw",{value:n}):t.raw=n,t};function ki(){var t=S("I'm a <b>paragraph</b> !"),n=t[0],e=t[1];return I(Dn||(Dn=$i([`
		<`,` title="Paragraph">
			<div>
...
function logNumbers() {
	...
	`).concat(e,`
&lt;/crumbs-panel&gt;`),m=He(function(){return Oi(t,void 0,void 0,function(){var h;return Pi(this,function(v){switch(v.label){case 0:if(l)return[2];d(!0),c("0"),h=0,v.label=1;case 1:return h<=100?[4,new Promise(function(y){return setTimeout(y,10)})]:[3,4];case 2:v.sent(),c(Math.floor(h).toString()),v.label=3;case 3:return h+=.1+(100-h)/100,[3,1];case 4:return c("100"),d(!1),[2]}})})},[l]),b=function(){l||m()};return I(zn||(zn=Ii([`
		<`,` title="Panel">
	...
	&lt;crumbs-p
		...
		`).concat(u,`
	&lt;/crumbs-p&gt;
&lt;/crumbs-panel&gt;`);return I(Vn||(Vn=ji([`
		<`,` title="Tabs">
			<crumbs-tabs>
